...
class UserVerificationMail extends TechVillageMail
{
    /**
     * Send mail to user
    ...
    public function send($request)
    {
        ...
        $data = [
            '{logo}' => $this->logo,
            '{verification_url}' => route('user.userProfileVerification', ["token" => $request->activation_code ]),
            ...
            '{token_otp_expire}' => preference('otp_expire_time'),
        ];
