...
trait Metable
{
    ...
    {
        if (!isset($this->metaData)&& !($this->metaData instanceof Collection && count($this->metaData) > 0)) {
            return;
        }
    ...
    protected function saveMeta()
    {
        foreach ($this->metaData as $meta) {
            ...
            if ($meta->isDirty()) {
                ...
                $meta->setAttribute('owner_type', get_class($this));
    ...
    {
        return isset($this->metaKeyName) ? $this->metaKeyName : 'owner_id';
    }
    ...
    {
        return isset($this->metaClass) ? $this->metaClass : \App\Models\MetaData::class;
    }
