                                    ...
                                    <div class="tab-pane p-0 fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <form action="{{ route('roles.store') }}" method="post" id="roleStore" class="form-horizontal">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" placeholder="{{ __('Name') }}" class="form-control inputFieldDesign" id="name" name="name" required pattern="^[a-zA-Z ]*$" oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" data-pattern="{{ __('Only alphabet and white space are allowed.') }}"  value="{{ old('name') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12 px-0 mt-2 mt-md-0">
                                                <a href="{{ route('roles.index') }}" class="py-2 me-2 custom-btn-cancel">{{ __('Cancel') }}</a>
