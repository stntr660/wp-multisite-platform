          ...
          <tr class="tbody-tr">
            ...
            <td colspan="2" class="tbody-td">
              ...
              @if(!empty($company_logo))
                @if(isExistFile("public/uploads/companyPic/". $company_logo))
                  <img src="{{ objectStorage()->url('/') . '/public/uploads/companyPic/' . $company_logo }}" alt="{{ objectStorage()->url('/') . 'public/uploads/companyPic/' . $company_logo }}" class="mt-1p5">
                @endif
              @endif
