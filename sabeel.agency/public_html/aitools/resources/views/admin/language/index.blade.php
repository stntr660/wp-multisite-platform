                                    ...
                                    <table id="dataTableBuilder" class="table table-hover table-striped dt-responsive">
                                        ...
                                        <tr>
                                            ...
                                            @if (array_intersect(['App\Http\Controllers\LanguageController@translation',
                                                    ...
                                                    'App\Http\Controllers\LanguageController@destroy'
                                                ], $prms)
                                            )
                                                <th>{{ __('Action') }}</th>
                                            @endif
                                            ...
                                            <tr>
                                                ...
                                                @if (array_intersect(['App\Http\Controllers\LanguageController@translation',
                                                    ...
                                                    <td>
                                                        ...
                                                        @if (in_array('App\Http\Controllers\LanguageController@destroy', $prms) && $language->is_default <> 1 && $language->short_name <> 'en')
                                                            <form method="POST" action="{{ route('language.destroy', $language->id) }}" accept-charset="UTF-8" id="delete-language-{{ $language->id }}" class="display_inline">
                                                                @csrf
                                                                @method('delete')
