...
|
*/
Route::group(['prefix' => 'admin', 'namespace' => 'Modules\MenuBuilder\Http\Controllers', 'middleware' => ['auth', 'locale', 'permission', 'web']], function () {
    Route::get('/menu-builder', 'MenuBuilderController@index')->name('menu.index');
    Route::post('create-newmenu', 'MenuController@createNewMenu')->middleware(['checkForDemoMode'])->name('menu.create');
    ...
    Route::post('generate-menu-control', 'MenuController@generateMenuControl')->middleware(['checkForDemoMode'])->name('menu.control');
