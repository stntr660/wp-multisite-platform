    ...
    <div class="col-sm-12" id="coupon-add-container">
        <div class="card">
            <div class="card-body row" id="theme-container">
                <div class="col-lg-3 col-12 z-index-10 ps-md-3 pe-0 ps-0 }}"
                            ...
                            <form action="{{ route('coupon.store') }}" method="post" class="form-horizontal">
                                ...
                                <div class="tab-content p-0 box-shadow-unset" id="topNav-v-pills-tabContent">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="d-flex date col-sm-6">
                                                        <div class="input-group-prepend">
                                                            <i
                                                                class="fas fa-calendar-alt input-group-text bg-white h-40 rounded-0  rounded-0 {{ languageDirection() == 'ltr' ? 'rounded-start border-end-0' : 'rounded-end border-start-0' }}"></i>
                                                        </div>
                                                        <input
                                    ...
                                    <div class="tab-pane fade" id="v-pills-restriction" role="tabpanel"
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control select-plans select2 sl_common_bx"
                                                    ...
                                                    @foreach ($plans as $plan)
                                                        <option {{ in_array($plan->id, old('plan_ids') ?? []) ? 'selected' : '' }} value="{{ $plan->id }}">{{ $plan->name }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="mt-5">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 control-label text-left" for="minimum_spend">
                                                {{ __('Minimum Spend') }}
                                                <div
                                                    class="tooltips cursor-pointer neg-transition-scale {{ languageDirection() == 'ltr' ? 'ms-2' : 'me-2' }}">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="switch switch-bg d-inline m-r-10 ">
                                                        <input class="is_default" name="individual_use"
                                                            type="checkbox" id="individual_use">
                                    ...
                                    <div class="tab-pane fade" id="v-pills-limit" role="tabpanel"
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-3 control-label" for="usage_limit_per_user">
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        class="tooltiptexts">{{ __('How many times this coupon can be used by an individual user.') }}</span>
                                                </div>
                                            </label>
                                            <div class="col-sm-6">
