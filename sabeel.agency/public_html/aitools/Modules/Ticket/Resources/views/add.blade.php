    ...
    <div id="add-ticket-container">
        <div class="card user-list">
            <div class="card-header">
                <h5><a href="{{ route('user.threads') }}">{{ __('Open Ticket') }}</a></h5>
            </div>
            <div class="card-block">
                ...
                <div class="tab-content {{ languageDirection() == 'ltr' ? 'ps-4' : 'pe-4' }}" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <form id="add_ticket_form" class="form-horizontal" action="{{ route('user.ticketStore') }}"
