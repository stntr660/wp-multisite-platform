...
@section('content')
    <div id="add-ticket-container">
        <div class="card">
            ...
            <div class="card-block">
                <div class="d-flex">
                    <p class="font-weight-bold font-bold p-b-0 {{ languageDirection() == 'ltr' ? 'ps-1' : 'pe-1' }} mb-2 f-16">{{ __('Subject') }}:</p>
                    <span class="f-16">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 m-t-5">
                        ...
                        @if (!empty($ticketDetails->assigned_member_id))
                            <span
                                class="cbadge cbadge-outlined cbadge-default {{ languageDirection() == 'ltr' ? 'ms-sm-0' : 'me-sm-0' }} mb-1 bolder-info">{{ __('Assignee') }}:
            ...
            <hr class="m-t-0">
            <div class="card-block">
                <form class="form-horizontal" id="reply_form" action="{{ route('user.threadReply.store') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 m-t-5">
                            <button type="submit" class="btn custom-btn-submit btn-reply {{ languageDirection() == 'ltr' ? 'float-right me-0' : 'float-left ms-0' }}"
                                id="btnSubmit"><i
                                        ...
                                        <div
                                            ...
                                            <div class="col-sm-2 px-2">
                                                <h6 class="media-heading txt-primary text-right"><a
                                                        href="{{ route('user.profile') }}">{{ $data->sender->name }}</a>
                                                </h6>
                                                <a href="{{ route('user.profile') }}" class="{{ languageDirection() == 'ltr' ? 'float-right me-4' : 'float-left ms-4' }}">
                                                    <img class="rounded-circle" width="45" height="45"
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
            <form method="POST" action="{{ route('user.updateReply') }}" id="replyModal">
                {{ csrf_field() }}
