...
if ($('.main-body .page-wrapper').find('#ticket-list-container').length) {
	...
	$(document).on("click", "#csv", function(event) {
		...
		window.location = SITE_URL + "/ticket_csv?from=" + $('#startfrom').val() + "&to=" + $('#endto').val() +"&project=" + $('#project').val() + "&status=" + $('#status').val() + "&assignee=" + $('#assignee').val();
	});
	$(document).on("click", "#pdf", function(event) {
		event.preventDefault();
		window.location = SITE_URL + "/ticket_pdf?from=" + $('#startfrom').val() + "&to=" + $('#endto').val() + "&project=" + $('#project').val() + "&status=" + $('#status').val() + "&assignee=" + $('#assignee').val();
	});
