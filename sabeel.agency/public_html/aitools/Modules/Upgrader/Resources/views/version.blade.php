    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-block text-center mt-3">
                ...
                <span class="text-muted">{{ __('Current version: ') }}</span> <span class="badge badge-info">{{ config('artifism.file_version', env('ARTIFISM_VERSION', '1.0.0')) }}</span>
                <div class="row justify-content-center">
    ...
    <div class="col-md-8">
        @if ($status == 'success')
            <div class="d-flex justify-content-start alert alert-warning">
                ...
                <a href="https://help.techvill.net/backup-artifismfiles-and-database/" target="_blank"><i class="feather icon-external-link"></i> {{ __('See backup documentation') }}</a></b>
            </div>
        @endif
