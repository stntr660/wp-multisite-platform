...
<div class="form-group row">
    ...
    <div class="col-sm-8 row">
        ...
        @endif
        @if (in_array('padding', $fields))
            <div class="col-sm-4 col-md-3">
                <div class="form-group row">
                    <label class="col-md-12">{{ __('Padding Top') }}</label>
                    <div class="col-md-12">
                        <input type="text" name="pt"
                            value="{{ $component && $component->pt ? $component->pt : '' }}" placeholder="10px | 10%"
                            class="form-control inputFieldDesign">
                    </div>
                </div>
            </div>
            <div class="col-sm-4 col-md-3">
                <div class="form-group row">
                    <label class="col-md-12">{{ __('Padding Bottom') }}</label>
                    <div class="col-md-12">
                        <input type="text" name="pb"
                            value="{{ $component && $component->pb ? $component->pb : '' }}" placeholder="10px | 10%"
                            class="form-control inputFieldDesign">
                    </div>
                </div>
            </div>
        ...
        @if (in_array('padding-vertical', $fields))
            <div class="col-sm-4 col-md-3">
                <div class="form-group row">
                    <label class="col-md-12">{{ __('Padding (Y-axis)') }}</label>
                    <div class="col-md-12">
                        <input type="text" name="pt_y"
                            value="{{ $component && $component->pt_y ? $component->pt_y : '' }}" placeholder="10px | 10%"
                            class="form-control inputFieldDesign">
                    </div>
                </div>
            </div>
