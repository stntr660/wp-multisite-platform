                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="header-btns-lg">
                                            <a href="{{ route('builder.edit', $page->slug) }}" target="_blank"
                                                class="header-btn folding btn-primary" data-toggle="tooltip"
                                                data-placement="top" title="{{ __('Edit with pagebuilder') }}"
                                            ...
                                            <a href="{{ route('page.home.edit', $page->slug) }}"
                                                class="header-btn folding btn-primary" data-toggle="tooltip"
                                                data-placement="top" title="{{ __('Edit page') }}"
                                            ...
                                            <a href="{{ route('site.page', $page->slug) }}" target="_blank"
                                                class="header-btn folding btn-primary" data-toggle="tooltip"
                                                data-placement="top" title="{{ __('View page') }}"
                                            ...
                                            @if (!$page->default)
                                                <span class="header-btn delete-button" data-toggle="tooltip"
                                                    ...
                                                    data-placement="top" title="{{ __('Delete page') }}"
                                            ...
                                            <a href="{{ route('page.home.export', $page->slug) }}"
                                                class="header-btn folding btn-primary" data-toggle="tooltip"
                                                data-placement="top" title="{{ __('Export Homepage') }}"
                                                data-original-title="{{ __('Export Homepage') }}">
                                                <i
