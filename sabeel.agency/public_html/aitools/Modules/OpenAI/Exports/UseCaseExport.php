...
class UseCaseExport implements FromCollection, WithHeadings, WithMapping
{
    /**
    ...
    {
        return UseCase::with(['user', 'user.metas'])->get();
    }
     ...
     */
    public function map($useCaseList): array
    {
        return[
            $useCaseList->name,
            $useCaseList->description,
            optional($useCaseList->user)->name,
            ucfirst($useCaseList->status),
            timeZoneFormatDate($useCaseList->created_at),
