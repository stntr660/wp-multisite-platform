...
namespace Modules\OpenAI\AiProviders\OpenAi\Responses\Template;

use Exception;
use Modules\OpenAI\Contracts\Responses\Template\TemplateResponseContract;

class TemplateResponse implements TemplateResponseContract
{
    /**
