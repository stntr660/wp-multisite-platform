...
class UseCaseCategoryRequest extends FormRequest
{
    use ApiResponse;
    ...
    {
        return [
            'name' => ['required', 'string', 'min:2', 'max:191', Rule::unique('use_case_categories', 'name')->ignore($this->id)],
            'slug' => ['required', 'max:191', Rule::unique('use_case_categories', 'slug')->ignore($this->id)],
