...
class ChatBotV2PermissionTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $parentId = Permission::firstOrCreate([
            'name' => 'Modules\\OpenAI\\Http\\Controllers\\Api\\v2\\User\\ChatBotController@index', 
            'controller_path' => 'Modules\\OpenAI\\Http\\Controllers\\Api\\v2\\User\\ChatBotController', 
        ...
        $parentId = Permission::firstOrCreate([
            'name' => 'Modules\\OpenAI\\Http\\Controllers\\Api\\v2\\User\\ChatBotController@show', 
            'controller_path' => 'Modules\\OpenAI\\Http\\Controllers\\Api\\v2\\User\\ChatBotController', 
            'controller_name' => 'ChatBotController',
            'method_name' => 'show',
        ]);
