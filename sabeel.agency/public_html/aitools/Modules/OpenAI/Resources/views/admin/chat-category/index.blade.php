        ...
        <div class="card-header bb-none pb-0 mb-2">
            ...
            <div class="card-header-right my-2 mx-md-0 mx-sm-4">
                ...
                @if (in_array('Modules\OpenAI\Http\Controllers\Admin\ChatCategoriesController@create', $prms))
                    <x-backend.button.add-new label="{{ __('Add :x', ['x' => __('Chat Category')]) }}" class="me-1" href="{{ route('admin.chat.category.create') }}" />
                @endif
...
<script type="text/javascript">
    'use strict';
    var pdf = "{{ in_array('Modules\OpenAI\Http\Controllers\Admin\ChatCategoriesController@pdf', $prms) ? '1' : '0' }}";
    var csv = "{{ in_array('Modules\OpenAI\Http\Controllers\Admin\ChatCategoriesController@csv', $prms) ? '1' : '0' }}";
    var listContaner = "use-case-category-list-container";
    var endRoute = "/chat-categories/";
</script>
