...
@section('content')
<!-- Main content -->
<div class="col-sm-12 list-container" id="speech-list-container">
    <div class="card">
...
<script type="text/javascript">
    'use strict';
    var pdf = "{{ in_array('Modules\OpenAI\Http\Controllers\Admin\SpeechToTextController@pdf', $prms) ? '1' : '0' }}";
    var csv = "{{ in_array('Modules\OpenAI\Http\Controllers\Admin\SpeechToTextController@csv', $prms) ? '1' : '0' }}";
    var listContaner = "speech-list-container";
    var endRoute = "/speech/";
</script>
