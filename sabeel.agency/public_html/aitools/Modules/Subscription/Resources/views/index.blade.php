        ...
        <div class="card-header bb-none pb-0">
            ...
            <div class="card-header-right my-2 mx-md-0 mx-sm-4">
                ...
                @if (in_array('Modules\Subscription\Http\Controllers\PackageSubscriptionController@create', $prms))
                    <a href="{{ route('package.subscription.create') }}" class="btn mb-0 btn-outline-primary custom-btn-small">
                        <span class="fa fa-plus"> &nbsp;</span>{{ __('Add Subscription') }}
                    </a>
                @endif
...
@section('js')
    <script type="text/javascript">
        ...
        var listContaner = "package-subscription-list-container";
        var endRoute = "/package-subscription/";
    </script>
